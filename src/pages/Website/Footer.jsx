	...
	return (
		<div className="footer-container">
			<section className="footer-subscription">
				<div className="form">
					<p className="footer-subscription-heading" style={{color: '#fff'}}>Stay updated as our conquest proceeds!</p>
					...
					<div className="input-areas">
						<form>
							...
							<Button buttonStyle="btn--outline" style={{color: '#fff'}}>Subscribe</Button>
						</form>
					</div>
				</div>
