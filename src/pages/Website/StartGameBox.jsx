  ...
  const getOptionContent = (mode) => {
    switch (mode) {
      case 0:
        return (
          <StartContent
            setModeToOne={handleModeOne}
            setModeToTwo={handleModeTwo}
          />
        );
      case 1:
  ...
  return (
    <Grid items xs={12}>
      <DialogContentText style={{ color: "white" }}>
        Join a world war and save the day.
      </DialogContentText>
      <Paper className="gamebox-wrapper">
        <form
          action={window.location
      ...
      <Paper className="gamebox-wrapper">
        ...
        >
          ...
          <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
            <label>
              <input class="uk-checkbox" type="checkbox" name="private" /> Make
              this a private game
            </label>
          </div>
          <div class="uk-margin">
            <label class="uk-form-label">
              Interval of Troop Drops [Realtime and Capital Supremacy Modes
              Only]
            </label>
            <Slider
              defaultValue={5}
